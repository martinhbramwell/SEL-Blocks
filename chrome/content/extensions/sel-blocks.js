 ...
 */
 ...
 /**
 *
 *  Martin Bramwell's contribution (making 1.3.1a):
 *  - loadJsonVars - capability to add variables to storedVars from a JSON file
 *  - forJson - capability to loop with for/each over an array of JSON entries
 *  - provision of test scripts that demonstrate usage of the key features
 *  - provision of clean & build scripts to facilitate recreating the XPI
 *
 */
...
/* ******************  start of Bramwell's JSON reader ****************** */
function JSONReader()
{
  var jsonDoc = null;
  var varNodes = null;
